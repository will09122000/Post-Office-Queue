...
int main (int argc, char **argv)
{
    ...
    for (i=0; i < numSims; i++)
    {
        ...
        else
        {
            ...
            outputParams.totalcustomersServed = outputParams.totalcustomersServed + outputLog[outputParams.currentTime-1][3];
            outputParams.totalcustomersUnfulfilled = outputParams.totalcustomersUnfulfilled + outputLog[outputParams.currentTime-1][4];
            outputParams.totalcustomersTimedOut = outputParams.totalcustomersTimedOut + outputLog[outputParams.currentTime-1][5];
              ...
              int outputLog[][6])
{
    ...
    for (currentTime=0; currentTime < closingTime; currentTime++)
    {
        ...
        for (i=0; i < newCustomers; i++)
        {
            ...
            {
                int waitLimit = (int) gsl_ran_flat(&r, lowerLimitWaitTolerance,
